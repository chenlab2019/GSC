...
b<-!(rownames(exprs_with_time2)  %in% promoter[,1])
a<-rowVars(exprs_with_time2[b,])
exprs_with_time=exprs_with_time2[rev(order(a))[1:70000],]


############rank = 2
res2_ATAC_allpeak <- nmf(exprs_with_time, 2,'ns',nrun=50,.opt='vP60',seed=122)
pdf(file ="cpm51samles_nrun50_nmf2.ns.pdf",width = 8,height = 8)
...
pdf(file ="cpm51samles_nrun50_nmf6.pdf",width = 8,height = 8)
consensusmap(res5_ATAC_allpeak)
dev.off()
#summary(res5_ATAC_allpeak)
cophcor(consensus(res5_ATAC_allpeak))
...
pdf(file ="cpm51samles_nrun50_nmf7.pdf",width = 8,height = 8)
consensusmap(res5_ATAC_allpeak)
dev.off()
#summary(res5_ATAC_allpeak)
cophcor(consensus(res5_ATAC_allpeak))
...
pdf(file ="cpm51samles_nrun50_nmf8.pdf",width = 8,height = 8)
consensusmap(res5_ATAC_allpeak)
dev.off()
#summary(res5_ATAC_allpeak)
cophcor(consensus(res5_ATAC_allpeak))
